...
pygame.init()
pygame.mixer.init()
pygame.mixer.music.load("TSIS/TSIS3/music,sounds/bg_sound.mp3")
...
coin_img  = pygame.image.load("TSIS/TSIS3/images/coin.png")
coin_img  = pygame.transform.scale(coin_img, (30, 30))

racer_img = pygame.image.load("TSIS/TSIS3/images/car.png")
racer_img = pygame.transform.scale(racer_img, (50, 70))

enemy_img = pygame.image.load("TSIS/TSIS3/images/enemy1.png")
enemy_img = pygame.transform.scale(enemy_img, (50, 70))

street_img = pygame.image.load("TSIS/TSIS3/images/background.png")
